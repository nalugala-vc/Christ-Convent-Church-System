...
@section('content')
<form method="POST" action="{{ route('addChild') }}"  enctype="multipart/form-data" id="reg-form">
...
@csrf
    <div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <input id="guardian_name" type="text" class="form-control @error('guardian_name') is-invalid @enderror" name="guardian_name" value="{{ old('guardian_name') }}" autocomplete="guardian_name" 
                data-autocomplete-url="{{ route('getMembersNames') }}"
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <input id="DOB" type="date" class="form-control @error('DOB') is-invalid @enderror" name="DOB" value="{{ old('DOB') }}" required autocomplete="DOB" placeholder="Date Of Birth">

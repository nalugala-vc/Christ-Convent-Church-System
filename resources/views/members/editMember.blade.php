...
@method('PUT')
    <div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <input id="spouse_name" type="text" class="form-control @error('spouse_name') is-invalid @enderror" name="spouse_name" value="{{ $member->spouse_name }}" required autocomplete="spouse_name" placeholder="Spouse Name">
